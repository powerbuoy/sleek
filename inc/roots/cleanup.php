...
function roots_excerpt_more($more) {
  return ' &hellip; <a href="' . get_permalink() . '">' . __('Continued', 'sleek') . '</a>';
}
...
# add_filter('get_search_form', 'roots_get_search_form'); # No, this prevents me using my own for some reason
